                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                        ...
                        <div class="detail-slider">
                            <div class="feature-slider">
                                <div><img src="page_asset/images/h-feature-1.jpg" class="img-responsive" alt="feature-img"/></div>
                                <div><img src="page_asset/images/h-feature-2.jpg" class="img-responsive" alt="feature-img"/></div>
                                <div><img src="page_asset/images/h-feature-3.jpg" class="img-responsive" alt="feature-img"/></div>
                                <div><img src="page_asset/images/h-feature-4.jpg" class="img-responsive" alt="feature-img"/></div>
                                <div><img src="page_asset/images/h-feature-5.jpg" class="img-responsive" alt="feature-img"/></div>
                            </div><!-- end feature-slider -->
                          
                            <div class="feature-slider-nav">
                                <div><img src="page_asset/images/h-feature-thumb-1.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                <div><img src="page_asset/images/h-feature-thumb-2.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                <div><img src="page_asset/images/h-feature-thumb-3.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                <div><img src="page_asset/images/h-feature-thumb-4.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                <div><img src="page_asset/images/h-feature-thumb-5.jpg" class="img-responsive" alt="feature-thumb"/></div>
                          ...
                          <ul class="nav nav-tabs nav-justified">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="hotel-overview" class="tab-pane in active">
                                  <div class="row">
                                    <div class="col-sm-4 col-md-4 tab-img">
                                        <img src="page_asset/images/hotel-detail-tab-1.jpg" class="img-responsive" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="restaurant" class="tab-pane">
                                  <div class="row">
                                    <div class="col-sm-4 col-md-4 tab-img">
                                        <img src="page_asset/images/hotel-detail-tab-2.jpg" class="img-responsive" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="pick-up" class="tab-pane">
                                  <div class="row">
                                    <div class="col-sm-4 col-md-4 tab-img">
                                        <img src="page_asset/images/hotel-detail-tab-3.jpg" class="img-responsive" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="luxury-gym" class="tab-pane">
                                  <div class="row">
                                    <div class="col-sm-4 col-md-4 tab-img">
                                        <img src="page_asset/images/hotel-detail-tab-4.jpg" class="img-responsive" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                                ...
                                <div id="sports-club" class="tab-pane">
                                  <div class="row">
                                    <div class="col-sm-4 col-md-4 tab-img">
                                        <img src="page_asset/images/hotel-detail-tab-5.jpg" class="img-responsive" alt="flight-detail-img" />
                                        </div><!-- end columns -->
                          ...
                          <div class="list-block main-block room-block">
                                <div class="list-content">
                                    <div class="main-img list-img room-img">
                                        <a href="#">
                                            <img src="page_asset/images/available-room-1.jpg" class="img-responsive" alt="room-img" />
                                        </a>
                                        <div class="main-mask">
                            ...
                            <div class="list-block main-block room-block">
                                <div class="list-content">
                                    <div class="main-img list-img room-img">
                                        <a href="#">
                                            <img src="page_asset/images/available-room-2.jpg" class="img-responsive" alt="room-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                            ...
                            <div class="list-block main-block room-block">
                                <div class="list-content">
                                    <div class="main-img list-img room-img">
                                        <a href="#">
                                            <img src="page_asset/images/available-room-3.jpg" class="img-responsive" alt="room-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
                            ...
                            <div class="list-block main-block room-block">
                                <div class="list-content">
                                    <div class="main-img list-img room-img">
                                        <a href="#">
                                            <img src="page_asset/images/available-room-4.jpg" class="img-responsive" alt="room-img" />
                                        </a>
                                        <div class="main-mask">
                                            <ul class="list-unstyled list-inline offer-price-1">
