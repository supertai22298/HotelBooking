...
@endsection
@section('title')
  Chỉnh sửa tình trạng thanh toán
@endsection
                  ...
                  <div class="page-header float-right">
                      <div class="page-title">
                          ...
                          <li><a href="{{ route('get-admin-view') }}">Dashboard</a></li>
                              ...
                              <li><a href="{{ route('get-payment-status-edit', ['id' => $paymentStatus->id]) }}">Chỉnh sửa</a></li>
                          </ol>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-8">
                <div class="row form-group">
                  ...
                  <div class="col-12 col-md-9">
                    <input type="number" name="id" value="{{$paymentStatus->id}}" class="d-none">
                    <input type="text" name="payment_status" id="payment_status" placeholder="Nhập tình trạng thanh toán mới" value="{{$paymentStatus->payment_status}}"
                ...
                <div class="row form-group">
                  ...
                  <div class="col-12 col-md-9"><textarea name="description" rows="4" cols="50" placeholder="Nội dung..." class="form-control" data-parsley-trigger="change">{{$paymentStatus->description}}</textarea></div>
                </div>
                <div class="row form-group">
                  ...
                  <div class="col-12 col-md-9">
                      <select name="active" class="form-control" data-parsley-trigger="change">
                          <option value="1" {{$paymentStatus->active == 1 ? 'selected': ''}}>Hoạt động</option>
                          <option value="0" {{$paymentStatus->active == 0 ? 'selected': ''}}>Không hoạt động</option>
                      </select>
                  </div>
                </div>
